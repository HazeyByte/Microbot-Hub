...
import lombok.Data;
import net.runelite.client.plugins.microbot.irkedSlayer.IrkedSlayerCombatStyle;
 ...
 */
@Data
public class IrkedSlayerTaskProfileJson {
    ...
    /**
     * Gets the parsed IrkedSlayerPrayer enum from the prayer string.
     */
    public IrkedSlayerPrayer getParsedPrayer() {
        return IrkedSlayerPrayer.fromString(prayer);
    }

    /**
     * Gets the parsed IrkedSlayerCombatStyle enum from the style string.
     */
    public IrkedSlayerCombatStyle getParsedStyle() {
        return IrkedSlayerCombatStyle.fromString(style);
    }
    ...
    public boolean hasPrayer() {
        return prayer != null && !prayer.isEmpty() && getParsedPrayer() != IrkedSlayerPrayer.NONE;
    }
    ...
    public boolean shouldUseGoading() {
        ...
        IrkedSlayerCombatStyle combatStyle = getParsedStyle();
