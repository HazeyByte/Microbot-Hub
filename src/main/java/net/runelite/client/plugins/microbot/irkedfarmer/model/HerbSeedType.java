...
/** Herb seeds selectable for the herb run. Ported from herbrun HerbSeedType. */
@Getter
public enum HerbSeedType {
    BEST("Best available", -1, 0), // dynamic: highest-level plantable
    ...
    /** Plantable herbs at the given farming level, highest-level first. */
