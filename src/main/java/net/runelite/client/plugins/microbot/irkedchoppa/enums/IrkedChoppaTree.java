...
public enum IrkedChoppaTree {
    ...
    LIGHT_JUNGLE("light jungle", "Thatch spar light", ItemID.THATCHING_SPAR_LIGHT, 10, "Chop down"),
    OAK("oak tree", "Oak logs", ItemID.OAK_LOGS,15, "Chop down"),
    MEDIUM_JUNGLE("medium jungle", "Thatch spar med", ItemID.THATCHING_SPAR_MED, 20, "Chop down"),
    ...
    DENSE_JUNGLE("dense jungle", "Thatch spar dense", ItemID.THATCHING_SPAR_DENSE, 35, "Chop down"),
    ...
    HOLLOW_TREE("hollow tree", "Bark", ItemID.HOLLOW_BARK, 45, "Chop down"),
    MAHOGANY("mahogany tree", "Mahogany logs", ItemID.MAHOGANY_LOGS, 50, "Chop down"),
    ARCTIC_PINE("arctic pine", "Arctic pine logs", ItemID.ARCTIC_PINE_LOG, 54, "Chop down"),
    ...
    SULLIUSCEP("sulliuscep", "Sulliuscep cap", ItemID.FOSSIL_SULLIUSCEP_CAP, 65, "Chop down"),
