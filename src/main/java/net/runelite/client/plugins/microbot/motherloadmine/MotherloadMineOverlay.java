...
@Slf4j
public class MotherloadMineOverlay extends Overlay {
    ...
    private final MotherloadMineScript script;
    private final ItemManager itemManager;

    @Inject
    public MotherloadMineOverlay(MotherloadMinePlugin plugin, MotherloadMineScript script) {
        super(plugin);
        this.script = script;
    ...
    public Dimension render(Graphics2D g) {
        ...
        curY = drawRow(g, curY, labelFont, boldFont,
                "Nuggets",
                snap.getGainedNuggets() + " gained  |  " + snap.getTotalNuggets() + " inv");
