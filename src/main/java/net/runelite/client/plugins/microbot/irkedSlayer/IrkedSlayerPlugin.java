...
import net.runelite.client.plugins.microbot.irkedSlayer.combat.IrkedSlayerDodgeScript;
import net.runelite.client.plugins.microbot.irkedSlayer.combat.IrkedSlayerFlickerScript;
import net.runelite.client.plugins.microbot.irkedSlayer.combat.IrkedSlayerHighAlchScript;
...
public class IrkedSlayerPlugin extends Plugin {
    ...
    @Inject
    private IrkedSlayerScript slayerScript;

    @Inject
    private IrkedSlayerOverlay slayerOverlay;

    @Inject
    private OverlayManager overlayManager;

    @Inject
    private IrkedSlayerStateController stateController;

    @Inject
    private IrkedSlayerFlickerScript flickerScript;

    @Inject
    private IrkedSlayerDodgeScript dodgeScript;

    @Inject
    private IrkedSlayerHighAlchScript highAlchScript;

    @Provides
    IrkedSlayerConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(IrkedSlayerConfig.class);
    }

    @Override
    protected void startUp() throws AWTException {
        log.info("Irked Slayer plugin started");
    ...
    protected void shutDown() {
        log.info("Irked Slayer plugin stopped");
    ...
    public void onGameTick(GameTick gameTick) {
        try {
            ...
            log.error("IrkedSlayer Plugin onGameTick Error: " + e.getMessage());
        }
    }
    ...
    public void onNpcDespawned(NpcDespawned npcDespawned) {
        try {
            ...
            log.error("IrkedSlayer Plugin onNpcDespawned Error: " + e.getMessage());
        }
    }
    ...
    public void onHitsplatApplied(HitsplatApplied event) {
        try {
            ...
            log.error("IrkedSlayer Plugin onHitsplatApplied Error: " + e.getMessage());
        }
    }
    ...
    public void onProjectileMoved(ProjectileMoved event) {
        try {
            ...
            log.error("IrkedSlayer Plugin onProjectileMoved Error: " + e.getMessage());
        }
    }
    ...
    public void onActorDeath(ActorDeath event) {
        try {
            ...
            log.error("IrkedSlayer Plugin onActorDeath Error: " + e.getMessage());
        }
    }
}
