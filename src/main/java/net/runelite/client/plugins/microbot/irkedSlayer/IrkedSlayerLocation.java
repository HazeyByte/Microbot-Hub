...
public enum IrkedSlayerLocation {
    ...
    /**
     * Find a IrkedSlayerLocation by its key (case-insensitive).
     * @param name The location name from the profile
     * @return The matching IrkedSlayerLocation, or null if not found
     */
    public static IrkedSlayerLocation fromName(String name) {
